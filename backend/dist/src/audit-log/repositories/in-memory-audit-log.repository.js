...
let InMemoryAuditLogRepository = class InMemoryAuditLogRepository {
    constructor() {
        this.entries = [];
    }
    async record(params) {
        const entry = { ...params, id: crypto.randomUUID(), createdAt: new Date() };
...
exports.InMemoryAuditLogRepository = InMemoryAuditLogRepository = __decorate([
